...
const packageDefintion = protoLoader.loadSync(`${__dirname}/monster_api.proto`, {
  enums: String,
  defaults: true
});
...
function getMonsters(call, callback) {
  ...
  Promise.all([monsterStore.getTotalMonsterCount(), monsterStore.getMonstersRange(limit, offset)])
    .then(results => {
...
monsterApiServer.addService(monsterApi.MonsterApiService.service, {
  getMonster,
  getMonsters,
